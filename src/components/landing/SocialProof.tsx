        ...
        <section style={{ paddingTop: '40px', paddingBottom: '40px' }}>
            <div className="container-db">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px' }}>
                    ...
                    >
                        <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(106,0,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
                        ...
                        <div style={{ width: '100%', maxWidth: '280px', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '14px' }}>
                            {[
                                ...
                                { icon: Shield, text: 'Full transparency, every pick tracked', color: '#FFC107' },
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '14px', flex: 1 }}>
                            {[
                                { user: 'YourSwamiBot', msg: '⚾ NEW PICK: Yankees -1.5 | HIGH', color: '#FFC107' },
                ...
                <div style={{ marginTop: '16px', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '20px' }}>
                    {[
                        ...
                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#9ca3af', fontSize: '14px' }}>
                            <item.icon size={14} style={{ color: 'rgba(106,0,255,0.5)' }} />
                            <span>{item.text}</span>
                        </div>
                    ))}
                </div>
