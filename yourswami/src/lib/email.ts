...
function pickAlertHtml(pick: PickAlertEmail): string {
    ...
    <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #0a0a0a; color: #e5e7eb; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 28px;">
            ...
            <a href="https://yourswami.com/dashboard" style="display: block; text-align: center; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; padding: 14px 24px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 15px;">
                View Full Analysis →
            </a>
        </div>
...
function resultHtml(pick: ResultEmail): string {
    ...
    <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #0a0a0a; color: #e5e7eb; border-radius: 16px; overflow: hidden;">
        ...
        <div style="padding: 28px;">
            ...
            <a href="https://yourswami.com/dashboard" style="display: block; text-align: center; background: linear-gradient(135deg, ${gradientColor} 0%, ${gradientColor}cc 100%); color: ${isWin ? '#0a0a0a' : 'white'}; padding: 14px 24px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 15px;">
                View Dashboard →
            </a>
        </div>
        <div style="padding: 16px 28px; border-top: 1px solid rgba(255,255,255,0.06); text-align: center;">
